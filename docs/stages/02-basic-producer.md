...
**What was built**: A shared `Kafka` client (`shared/kafka.ts`) and
`Order` type (`shared/types.ts`), plus `producer.ts`, which connects a
...
[course/stage02-producer/](../../course/stage02-producer/).
