...
docker exec -i clickhouse clickhouse-client --password kafkaos --multiquery < ../db/clickhouse/schema.sql
...
docker exec -i clickhouse clickhouse-client --password kafkaos --multiquery < ../db/clickhouse/parse.sql
